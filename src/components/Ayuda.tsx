...
const SECCIONES: SeccionAyuda[] = [
  ...
  },
  {
    ...
    tier: 'basico',
    descripcion: 'Carga diaria simple, para un control rápido del día a día — sin IVA ni cuotas.',
    pasos: [
      'Elegí si es un ingreso o un gasto.',
      'Cargá el monto, la fecha y un concepto corto. Si es un cliente o un proveedor, escribí su nombre ahí: con eso se arman solas las pantallas de Clientes y Proveedores.',
      'Marcá `Facturado` o `Sin factura`. Lo facturado cuenta para Monotributo, Ingresos Brutos e IVA; lo que va sin factura queda afuera de los impuestos.',
      'En cualquiera de los dos casos, cada ingreso queda registrado como una venta y cada gasto como una compra, así alimentan tu Dashboard, el margen y la proyección de caja en vez de quedar en una lista suelta.',
    ],
    tip: 'Lo marcado como `Sin factura` es lo que antes se llamaba comprobante interno: suma a tus números del negocio, pero nunca se mezcla con lo que va a ARCA ni aparece en el Excel para el contador.',
  },
  {
    id: 'cobranzas',
    numero: '04',
  ...
  },
  {
    ...
    pasos: [
      ...
      'Arriba hay un mes elegido que gobierna toda la pantalla: los totales, los pagos y lo que cobró cada uno son de ese mes.',
      'Para el que no cobra siempre lo mismo —jornales, horas, changas, comisiones— abrí su ficha y cargá `Cobró en <mes>`. Solo afecta a ese mes; los demás siguen con el sueldo fijo.',
      ...
      'Mirá el resumen de la nómina del mes elegido: sueldos brutos, contribuciones, cargas sociales y costo total para la empresa.',
      ...
      'En junio y diciembre aparece además el aguinaldo (SAC): la mitad de la mejor remuneración del semestre de cada empleado, con sus mismas cargas. Si cargaste lo que cobró mes a mes, toma el mejor de esos seis meses, como corresponde; si no, el sueldo fijo.',
  ...
  },
  {
    ...
    pasos: [
      'Se completa sola con cada gasto que cargues en Ingresos y gastos, y con cada factura recibida que cargues en Comprobantes.',
      'Si cargás por Ingresos y gastos, escribí el nombre del proveedor en el concepto: ese es el nombre que aparece acá.',
  ...
  },
  {
    ...
    pasos: [
      'Se completa sola con cada venta que cargues, sea en Ingresos y gastos o en Comprobantes.',
      'Si cargás por Ingresos y gastos, escribí el nombre del cliente en el concepto: ese es el nombre que aparece acá.',
      'Podés agregar un cliente a mano si todavía no le vendiste.',
    ],
  },
  {
    id: 'presupuesto-real',
  ...
  },
  {
    ...
    pasos: [
      'Se calcula solo a partir de tus ventas facturadas, las cargues en Ingresos y gastos o en Comprobantes.',
      'Lo que en Ingresos y gastos marcaste como `Sin factura` no entra en la base imponible, que es lo correcto.',
  ...
  },
  {
    ...
    pasos: [
      ...
      'La facturación de los últimos 12 meses se calcula sola con tus ventas facturadas, las cargues en Ingresos y gastos o en Comprobantes. Lo marcado como `Sin factura` no cuenta. Si necesitás otro número, escribilo y pisa al calculado.',
